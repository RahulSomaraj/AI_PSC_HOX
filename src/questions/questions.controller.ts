...
export class QuestionsController {
  ...
  async getRandomQuestions(
    ...
    return await this.questionsService.getRandomQuestions(+courseId, limit ? +limit : 10);
  }
  ...
  async getQuestionsByDifficulty(
    ...
    return await this.questionsService.getQuestionsByDifficulty(+courseId, +difficulty);
  }
  ...
  async update(
    ...
    return await this.questionsService.update(+id, updateQuestionDto, updatedBy);
  }
